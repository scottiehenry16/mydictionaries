...
#print()
#for value in ProduceDictionary:
#    print(f"these are the values {ProduceDictionary[value]}")
#cost = ProduceDictionary[produce] gives you the full value, not specific one
